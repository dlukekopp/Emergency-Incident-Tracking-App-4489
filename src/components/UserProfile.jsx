...
const { FiUser, FiEdit3, FiSave, FiEye, FiEyeOff, FiActivity, FiPhone, FiMail, FiCamera, FiX } = FiIcons;
...
function UserProfile({ onClose }) {
  ...
  const formatActionDescription = (log) => {
    switch (log.action) {
      ...
      case 'STATUS_CHANGE':
        return `Changed ${log.entityType} status`;
      default:
                ...
                {isEditing && (
                  <>
                    <div className="border-t pt-6">
                      <h4 className="text-lg font-medium text-gray-900 mb-4">Change PIN (Optional)</h4>
